...
- `OAUTH_CLIENT_ID_OAUTH2AUTH`: Your OAuth client ID
- `OAUTH_CLIENT_SECRET_OAUTH2AUTH`: Your OAuth client secret
- `OAUTH_TOKEN_OAUTH2AUTH`: Pre-acquired OAuth token (required for authorization code flow)

**Authorization Code Flow:**

- Authorization URL: `https://{host}:{port}`
- Token URL: `https://{host}:{port}`
